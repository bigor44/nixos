...
This repository contains my personal NixOS configuration, managed declaratively
using Nix and NixOS. It includes system-wide and user-specific settings, as well
as configurations for the Cosmic desktop environment.

---

## Features

- **Declarative System Configuration:** Everything is defined in Nix expressions
  for reproducibility.
- **Multi-Host Support:** Configurations for multiple machines (`grospc`,
  `minipc`).
- **Cosmic Desktop Environment:** Custom settings for Cosmic (System76's desktop
  environment).
- **Home Manager Integration:** User-specific configurations for tools like
  Neovim, VSCode, Zsh, and Git.
